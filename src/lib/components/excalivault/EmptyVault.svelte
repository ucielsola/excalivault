...
{#snippet defaultContent()}
    <div class="flex flex-1 flex-col items-center justify-center gap-4 p-6">
        <div class="relative">
            ...
            <div class="absolute -inset-8 rounded-full bg-primary/2"></div>
            <div
                class="relative flex h-16 w-16 items-center justify-center rounded-xl border border-dashed border-border bg-secondary"
            >
                <ShieldIcon
                    size={28}
        ...
        {:else}
            <Button
                ...
                class="gap-2"
                onclick={() =>
                    browser.tabs.create({ url: "https://excalidraw.com/" })}
            >
